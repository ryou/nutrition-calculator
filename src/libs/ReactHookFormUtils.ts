import { Path, UseFormGetFieldState, UseFormStateReturn } from 'react-hook-form'

export const getRHFErrorMessage = <T>(
   ...
   */
  return getFieldState(path, formState).error?.message
}
